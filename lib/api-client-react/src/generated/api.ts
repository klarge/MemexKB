 ...
 */
export const resetRecoveredPassword = async (passwordRecoveryInput: PasswordRecoveryInput, options?: Parameters<typeof customFetch>[1]): Promise<MessageResponse> => {
...
export const getResetRecoveredPasswordMutationKey = () => ['resetRecoveredPassword'] as const;

export const getResetRecoveredPasswordMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof resetRecoveredPassword>>, TError,ResetRecoveredPasswordMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof resetRecoveredPassword>>, TError,ResetRecoveredPasswordMutationVariables, TContext> => {

const mutationKey = getResetRecoveredPasswordMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof resetRecoveredPassword>>, ResetRecoveredPasswordMutationVariables> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ResetRecoveredPasswordMutationVariables = {data: BodyType<PasswordRecoveryInput>}
...
export const useResetRecoveredPassword = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof resetRecoveredPassword>>, TError,ResetRecoveredPasswordMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        ResetRecoveredPasswordMutationVariables,
        TContext
      > => {
 ...
 */
export const listApiTokens = async ( options?: Parameters<typeof customFetch>[1]): Promise<ApiToken[]> => {
...
export const getCreateApiTokenMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createApiToken>>, TError,CreateApiTokenMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateApiTokenMutationVariables = {data: BodyType<ApiTokenInput>}
 ...
 */
export const revokeApiToken = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<MessageResponse> => {
...
export const getRevokeApiTokenMutationKey = () => ['revokeApiToken'] as const;

export const getRevokeApiTokenMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof revokeApiToken>>, TError,RevokeApiTokenMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof revokeApiToken>>, TError,RevokeApiTokenMutationVariables, TContext> => {

const mutationKey = getRevokeApiTokenMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof revokeApiToken>>, RevokeApiTokenMutationVariables> = (props) => {
          const {id} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RevokeApiTokenMutationVariables = {id: number}
...
export const getCreateArticleMutationKey = () => ['createArticle'] as const;

export const getCreateArticleMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createArticle>>, TError,CreateArticleMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createArticle>>, TError,CreateArticleMutationVariables, TContext> => {

const mutationKey = getCreateArticleMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createArticle>>, CreateArticleMutationVariables> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateArticleMutationVariables = {data: BodyType<ArticleInput>}
 ...
 */
export const listArticlesMaintenance = async (params?: ListArticlesMaintenanceParams, options?: Parameters<typeof customFetch>[1]): Promise<ArticleListResponse> => {
...
export const listProjectDocuments = async (projectId: number, options?: Parameters<typeof customFetch>[1]): Promise<ProjectDocumentListResponse> => {
  ...
  return customFetch<ProjectDocumentListResponse>(getListProjectDocumentsUrl(projectId),
  {
    ...options,
    method: 'GET'
...
export const getListProjectDocumentsQueryOptions = <TData = Awaited<ReturnType<typeof listProjectDocuments>>, TError = ErrorType<ErrorResponse>>(projectId: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listProjectDocuments>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type ListProjectDocumentsQueryError = ErrorType<ErrorResponse>
...
export function useListProjectDocuments<TData = Awaited<ReturnType<typeof listProjectDocuments>>, TError = ErrorType<ErrorResponse>>(
...
export const createProjectDocument = async (projectId: number,
    projectDocumentInput: ProjectDocumentInput, options?: Parameters<typeof customFetch>[1]): Promise<ProjectDocument> => {
...
return customFetch<ProjectDocument>(getCreateProjectDocumentUrl(projectId),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
...
export const getCreateProjectDocumentMutationKey = () => ['createProjectDocument'] as const;

export const getCreateProjectDocumentMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createProjectDocument>>, TError,CreateProjectDocumentMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createProjectDocument>>, TError,CreateProjectDocumentMutationVariables, TContext> => {

const mutationKey = getCreateProjectDocumentMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createProjectDocument>>, CreateProjectDocumentMutationVariables> = (props) => {
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateProjectDocumentMutationVariables = {projectId: number;data: BodyType<ProjectDocumentInput>}

    /**
 * @summary Create a document in a project
 */
export const useCreateProjectDocument = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createProjectDocument>>, TError,CreateProjectDocumentMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof createProjectDocument>>,
        TError,
        CreateProjectDocumentMutationVariables,
        TContext
      > => {
...
export const getGetProjectDocumentUrl = (projectId: number,
  ...
  return `/api/projects/${projectId}/documents/${slug}`
}
...
export const getProjectDocument = async (projectId: number,
    slug: string, options?: Parameters<typeof customFetch>[1]): Promise<ProjectDocument> => {

  return customFetch<ProjectDocument>(getGetProjectDocumentUrl(projectId,slug),
  {
    ...options,
    method: 'GET'
...
export const getGetProjectDocumentQueryKey = (projectId: number,
    slug: string,) => {
    return [
    `/api/projects/${projectId}/documents/${slug}`
    ] as const;
    }


export const getGetProjectDocumentQueryOptions = <TData = Awaited<ReturnType<typeof getProjectDocument>>, TError = ErrorType<unknown>>(projectId: number,
    slug: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getProjectDocument>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetProjectDocumentQueryKey(projectId,slug);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getProjectDocument>>> = ({ signal }) => getProjectDocument(projectId,slug, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: projectId !== null && projectId !== undefined && slug !== null && slug !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getProjectDocument>>, TError, TData> & { queryKey: QueryKey }
}

export type GetProjectDocumentQueryResult = NonNullable<Awaited<ReturnType<typeof getProjectDocument>>>
export type GetProjectDocumentQueryError = ErrorType<unknown>
...
export function useGetProjectDocument<TData = Awaited<ReturnType<typeof getProjectDocument>>, TError = ErrorType<unknown>>(
 projectId: number,
    slug: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getProjectDocument>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetProjectDocumentQueryOptions(projectId,slug,options)
...
export const getUpdateProjectDocumentUrl = (projectId: number,
    slug: string,) => {
 ...
 */
export const updateProjectDocument = async (projectId: number,
    slug: string,
    projectDocumentInput: ProjectDocumentInput, options?: Parameters<typeof customFetch>[1]): Promise<ProjectDocument> => {
...
return customFetch<ProjectDocument>(getUpdateProjectDocumentUrl(projectId,slug),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
...
export const getUpdateProjectDocumentMutationKey = () => ['updateProjectDocument'] as const;

export const getUpdateProjectDocumentMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateProjectDocument>>, TError,UpdateProjectDocumentMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateProjectDocument>>, TError,UpdateProjectDocumentMutationVariables, TContext> => {

const mutationKey = getUpdateProjectDocumentMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateProjectDocument>>, UpdateProjectDocumentMutationVariables> = (props) => {
          const {projectId,slug,data} = props ?? {};

          return  updateProjectDocument(projectId,slug,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateProjectDocumentMutationResult = NonNullable<Awaited<ReturnType<typeof updateProjectDocument>>>
    export type UpdateProjectDocumentMutationBody = BodyType<ProjectDocumentInput>
    export type UpdateProjectDocumentMutationError = ErrorType<unknown>
    export type UpdateProjectDocumentMutationVariables = {projectId: number;slug: string;data: BodyType<ProjectDocumentInput>}

    /**
 * @summary Update a project document
 */
export const useUpdateProjectDocument = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateProjectDocument>>, TError,UpdateProjectDocumentMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof updateProjectDocument>>,
        TError,
        UpdateProjectDocumentMutationVariables,
        TContext
      > => {
      return useMutation(getUpdateProjectDocumentMutationOptions(options));
    }

export const getDeleteProjectDocumentUrl = (projectId: number,
    slug: string,) => {
 ...
 */
export const deleteProjectDocument = async (projectId: number,
    slug: string, options?: Parameters<typeof customFetch>[1]): Promise<void> => {

  return customFetch<void>(getDeleteProjectDocumentUrl(projectId,slug),
  {
    ...options,
    method: 'DELETE'
...
export const getDeleteProjectDocumentMutationKey = () => ['deleteProjectDocument'] as const;

export const getDeleteProjectDocumentMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteProjectDocument>>, TError,DeleteProjectDocumentMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteProjectDocument>>, TError,DeleteProjectDocumentMutationVariables, TContext> => {

const mutationKey = getDeleteProjectDocumentMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteProjectDocument>>, DeleteProjectDocumentMutationVariables> = (props) => {
          const {projectId,slug} = props ?? {};

          return  deleteProjectDocument(projectId,slug,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteProjectDocumentMutationVariables = {projectId: number;slug: string}

    /**
 * @summary Delete a project document
 */
export const useDeleteProjectDocument = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteProjectDocument>>, TError,DeleteProjectDocumentMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof deleteProjectDocument>>,
        TError,
        DeleteProjectDocumentMutationVariables,
        TContext
      > => {
 ...
 */
export const getArticleStats = async ( options?: Parameters<typeof customFetch>[1]): Promise<ArticleStats> => {
...
export const getLogEntry = async (userId: number,
    logSlug: string, options?: Parameters<typeof customFetch>[1]): Promise<Article> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetLogEntryQueryKey(userId,logSlug);
   ...
   return  { queryKey, queryFn, enabled: userId !== null && userId !== undefined && logSlug !== null && logSlug !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getLogEntry>>, TError, TData> & { queryKey: QueryKey }
}
...
export const getUpdateArticleMutationKey = () => ['updateArticle'] as const;

export const getUpdateArticleMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateArticle>>, TError,UpdateArticleMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateArticle>>, TError,UpdateArticleMutationVariables, TContext> => {

const mutationKey = getUpdateArticleMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateArticle>>, UpdateArticleMutationVariables> = (props) => {
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateArticleMutationVariables = {slug: string;data: BodyType<ArticleUpdate>}
 ...
 */
export const deleteArticle = async (slug: string, options?: Parameters<typeof customFetch>[1]): Promise<MessageResponse> => {
...
export const getDeleteArticleMutationKey = () => ['deleteArticle'] as const;

export const getDeleteArticleMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteArticle>>, TError,DeleteArticleMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteArticle>>, TError,DeleteArticleMutationVariables, TContext> => {

const mutationKey = getDeleteArticleMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteArticle>>, DeleteArticleMutationVariables> = (props) => {
          const {slug} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteArticleMutationVariables = {slug: string}
...
export const updateArticleSlug = async (slug: string,
    articleSlugUpdate: ArticleSlugUpdate, options?: Parameters<typeof customFetch>[1]): Promise<ArticleSlugUpdateResult> => {
...
return customFetch<ArticleSlugUpdateResult>(getUpdateArticleSlugUrl(slug),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
    body: JSON.stringify(articleSlugUpdate)
  }
);}
...
export const getUpdateArticleSlugMutationKey = () => ['updateArticleSlug'] as const;

export const getUpdateArticleSlugMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateArticleSlug>>, TError,UpdateArticleSlugMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateArticleSlug>>, TError,UpdateArticleSlugMutationVariables, TContext> => {

const mutationKey = getUpdateArticleSlugMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateArticleSlug>>, UpdateArticleSlugMutationVariables> = (props) => {
          const {slug,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateArticleSlugMutationVariables = {slug: string;data: BodyType<ArticleSlugUpdate>}
...
export const useUpdateArticleSlug = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateArticleSlug>>, TError,UpdateArticleSlugMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        UpdateArticleSlugMutationVariables,
        TContext
      > => {
 ...
 */
export const getArticleLock = async (slug: string, options?: Parameters<typeof customFetch>[1]): Promise<EditLockStatus> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetArticleLockQueryKey(slug);
   ...
   return  { queryKey, queryFn, enabled: slug !== null && slug !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getArticleLock>>, TError, TData> & { queryKey: QueryKey }
}
 ...
 */
export const acquireArticleLock = async (slug: string, options?: Parameters<typeof customFetch>[1]): Promise<EditLockStatus> => {
...
export const getAcquireArticleLockMutationKey = () => ['acquireArticleLock'] as const;

export const getAcquireArticleLockMutationOptions = <TError = ErrorType<ErrorResponse | EditLockStatus>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof acquireArticleLock>>, TError,AcquireArticleLockMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof acquireArticleLock>>, TError,AcquireArticleLockMutationVariables, TContext> => {

const mutationKey = getAcquireArticleLockMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof acquireArticleLock>>, AcquireArticleLockMutationVariables> = (props) => {
          const {slug} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AcquireArticleLockMutationVariables = {slug: string}
...
export const useAcquireArticleLock = <TError = ErrorType<ErrorResponse | EditLockStatus>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof acquireArticleLock>>, TError,AcquireArticleLockMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        AcquireArticleLockMutationVariables,
        TContext
      > => {
 ...
 */
export const releaseArticleLock = async (slug: string, options?: Parameters<typeof customFetch>[1]): Promise<MessageResponse> => {
...
export const getReleaseArticleLockMutationKey = () => ['releaseArticleLock'] as const;

export const getReleaseArticleLockMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof releaseArticleLock>>, TError,ReleaseArticleLockMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof releaseArticleLock>>, TError,ReleaseArticleLockMutationVariables, TContext> => {

const mutationKey = getReleaseArticleLockMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof releaseArticleLock>>, ReleaseArticleLockMutationVariables> = (props) => {
          const {slug} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ReleaseArticleLockMutationVariables = {slug: string}
...
export const useReleaseArticleLock = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof releaseArticleLock>>, TError,ReleaseArticleLockMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        ReleaseArticleLockMutationVariables,
        TContext
      > => {
 ...
 */
export const getArticleBacklinks = async (slug: string, options?: Parameters<typeof customFetch>[1]): Promise<ArticleSummary[]> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetArticleBacklinksQueryKey(slug);
   ...
   return  { queryKey, queryFn, enabled: slug !== null && slug !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getArticleBacklinks>>, TError, TData> & { queryKey: QueryKey }
}
 ...
 */
export const exportArticleMarkdown = async (slug: string, options?: Parameters<typeof customFetch>[1]): Promise<string> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getExportArticleMarkdownQueryKey(slug);
   ...
   return  { queryKey, queryFn, enabled: slug !== null && slug !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof exportArticleMarkdown>>, TError, TData> & { queryKey: QueryKey }
}
 ...
 */
export const exportArticlePdf = async (slug: string, options?: Parameters<typeof customFetch>[1]): Promise<Blob> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getExportArticlePdfQueryKey(slug);
   ...
   return  { queryKey, queryFn, enabled: slug !== null && slug !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof exportArticlePdf>>, TError, TData> & { queryKey: QueryKey }
}
...
export const setArticleGroups = async (slug: string,
    articleGroupsInput: ArticleGroupsInput, options?: Parameters<typeof customFetch>[1]): Promise<Article> => {
...
return customFetch<Article>(getSetArticleGroupsUrl(slug),
  {
    ...
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
    body: JSON.stringify(articleGroupsInput)
  }
);}
...
export const getSetArticleGroupsMutationKey = () => ['setArticleGroups'] as const;

export const getSetArticleGroupsMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof setArticleGroups>>, TError,SetArticleGroupsMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof setArticleGroups>>, TError,SetArticleGroupsMutationVariables, TContext> => {

const mutationKey = getSetArticleGroupsMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof setArticleGroups>>, SetArticleGroupsMutationVariables> = (props) => {
          const {slug,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SetArticleGroupsMutationVariables = {slug: string;data: BodyType<ArticleGroupsInput>}
...
export const useSetArticleGroups = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof setArticleGroups>>, TError,SetArticleGroupsMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        SetArticleGroupsMutationVariables,
        TContext
      > => {
 ...
 */
export const uploadArticleImage = async (imageUploadInput: ImageUploadInput, options?: Parameters<typeof customFetch>[1]): Promise<ImageUploadResponse> => {
...
export const getUploadArticleImageMutationKey = () => ['uploadArticleImage'] as const;

export const getUploadArticleImageMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof uploadArticleImage>>, TError,UploadArticleImageMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof uploadArticleImage>>, TError,UploadArticleImageMutationVariables, TContext> => {

const mutationKey = getUploadArticleImageMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof uploadArticleImage>>, UploadArticleImageMutationVariables> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UploadArticleImageMutationVariables = {data: BodyType<ImageUploadInput>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateTagMutationVariables = {id: number;data: BodyType<TagUpdate>}
 ...
 */
export const deleteTag = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<MessageResponse> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteTagMutationVariables = {id: number}
 ...
 */
export const getUserGroups = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<Group[]> => {
 ...
 */
export const getGroup = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<GroupDetail> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateGroupMutationVariables = {id: number;data: BodyType<GroupUpdate>}
 ...
 */
export const deleteGroup = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<MessageResponse> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteGroupMutationVariables = {id: number}
...
export const addGroupMember = async (id: number,
    groupMemberInput: GroupMemberInput, options?: Parameters<typeof customFetch>[1]): Promise<MessageResponse> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof addGroupMember>>, AddGroupMemberMutationVariables> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AddGroupMemberMutationVariables = {id: number;data: BodyType<GroupMemberInput>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof removeGroupMember>>, RemoveGroupMemberMutationVariables> = (props) => {
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RemoveGroupMemberMutationVariables = {id: number;userId: number}
 ...
 */
export const adminExportAll = async ( options?: Parameters<typeof customFetch>[1]): Promise<Blob> => {
 ...
 */
export const adminImportAll = async (adminImportInput: AdminImportInput, options?: Parameters<typeof customFetch>[1]): Promise<AdminImportResponse> => {
    const formData = new FormData();
...
export const getAdminImportAllMutationKey = () => ['adminImportAll'] as const;

export const getAdminImportAllMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof adminImportAll>>, TError,AdminImportAllMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof adminImportAll>>, TError,AdminImportAllMutationVariables, TContext> => {

const mutationKey = getAdminImportAllMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof adminImportAll>>, AdminImportAllMutationVariables> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AdminImportAllMutationVariables = {data: BodyType<AdminImportInput>}
...
export const useAdminImportAll = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof adminImportAll>>, TError,AdminImportAllMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        AdminImportAllMutationVariables,
        TContext
      > => {
 ...
 */
export const previewAdminRestore = async (adminRestorePreviewInput: AdminRestorePreviewInput, options?: Parameters<typeof customFetch>[1]): Promise<AdminRestorePreview> => {
    const formData = new FormData();
...
export const getPreviewAdminRestoreMutationKey = () => ['previewAdminRestore'] as const;

export const getPreviewAdminRestoreMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof previewAdminRestore>>, TError,PreviewAdminRestoreMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof previewAdminRestore>>, TError,PreviewAdminRestoreMutationVariables, TContext> => {

const mutationKey = getPreviewAdminRestoreMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof previewAdminRestore>>, PreviewAdminRestoreMutationVariables> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PreviewAdminRestoreMutationVariables = {data: BodyType<AdminRestorePreviewInput>}
...
export const usePreviewAdminRestore = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof previewAdminRestore>>, TError,PreviewAdminRestoreMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        PreviewAdminRestoreMutationVariables,
        TContext
      > => {
...
export const getRestoreAdminBackupMutationKey = () => ['restoreAdminBackup'] as const;

export const getRestoreAdminBackupMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof restoreAdminBackup>>, TError,RestoreAdminBackupMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof restoreAdminBackup>>, TError,RestoreAdminBackupMutationVariables, TContext> => {

const mutationKey = getRestoreAdminBackupMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof restoreAdminBackup>>, RestoreAdminBackupMutationVariables> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RestoreAdminBackupMutationVariables = {data: BodyType<AdminRestoreInput>}
...
export const useRestoreAdminBackup = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof restoreAdminBackup>>, TError,RestoreAdminBackupMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        RestoreAdminBackupMutationVariables,
        TContext
      > => {
 ...
 */
export const exportFullEnvironmentBackup = async (fullBackupPassphraseInput: FullBackupPassphraseInput, options?: Parameters<typeof customFetch>[1]): Promise<Blob> => {
...
return customFetch<Blob>(getExportFullEnvironmentBackupUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
    body: JSON.stringify(fullBackupPassphraseInput)
  }
);}
...
export const getExportFullEnvironmentBackupMutationKey = () => ['exportFullEnvironmentBackup'] as const;

export const getExportFullEnvironmentBackupMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof exportFullEnvironmentBackup>>, TError,ExportFullEnvironmentBackupMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof exportFullEnvironmentBackup>>, TError,ExportFullEnvironmentBackupMutationVariables, TContext> => {

const mutationKey = getExportFullEnvironmentBackupMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof exportFullEnvironmentBackup>>, ExportFullEnvironmentBackupMutationVariables> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ExportFullEnvironmentBackupMutationVariables = {data: BodyType<FullBackupPassphraseInput>}
...
export const useExportFullEnvironmentBackup = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof exportFullEnvironmentBackup>>, TError,ExportFullEnvironmentBackupMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        ExportFullEnvironmentBackupMutationVariables,
        TContext
      > => {
 ...
 */
export const previewFullEnvironmentRestore = async (fullBackupRestoreInput: FullBackupRestoreInput, options?: Parameters<typeof customFetch>[1]): Promise<FullBackupPreview> => {
    const formData = new FormData();
...
export const getPreviewFullEnvironmentRestoreMutationKey = () => ['previewFullEnvironmentRestore'] as const;

export const getPreviewFullEnvironmentRestoreMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof previewFullEnvironmentRestore>>, TError,PreviewFullEnvironmentRestoreMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof previewFullEnvironmentRestore>>, TError,PreviewFullEnvironmentRestoreMutationVariables, TContext> => {

const mutationKey = getPreviewFullEnvironmentRestoreMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof previewFullEnvironmentRestore>>, PreviewFullEnvironmentRestoreMutationVariables> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PreviewFullEnvironmentRestoreMutationVariables = {data: BodyType<FullBackupRestoreInput>}
...
export const usePreviewFullEnvironmentRestore = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof previewFullEnvironmentRestore>>, TError,PreviewFullEnvironmentRestoreMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        PreviewFullEnvironmentRestoreMutationVariables,
        TContext
      > => {
 ...
 */
export const restoreFullEnvironmentBackup = async (fullBackupRestoreInput: FullBackupRestoreInput, options?: Parameters<typeof customFetch>[1]): Promise<FullBackupRestoreResult> => {
    const formData = new FormData();
formData.append(`file`, fullBackupRestoreInput.file);
formData.append(`passphrase`, fullBackupRestoreInput.passphrase);
if(fullBackupRestoreInput.mode !== undefined) {
...
export const getRestoreFullEnvironmentBackupMutationKey = () => ['restoreFullEnvironmentBackup'] as const;

export const getRestoreFullEnvironmentBackupMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof restoreFullEnvironmentBackup>>, TError,RestoreFullEnvironmentBackupMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof restoreFullEnvironmentBackup>>, TError,RestoreFullEnvironmentBackupMutationVariables, TContext> => {

const mutationKey = getRestoreFullEnvironmentBackupMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof restoreFullEnvironmentBackup>>, RestoreFullEnvironmentBackupMutationVariables> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RestoreFullEnvironmentBackupMutationVariables = {data: BodyType<FullBackupRestoreInput>}
...
export const useRestoreFullEnvironmentBackup = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof restoreFullEnvironmentBackup>>, TError,RestoreFullEnvironmentBackupMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        RestoreFullEnvironmentBackupMutationVariables,
        TContext
      > => {
